...
namespace Aimlabs.App
{
    public class Scoreboard : World
    {
        ...
        public override void Prepare()
        {
            ...
            playagain.SetPosition(Window.Width / 2, Window.Height / 7 );
            playagain.Name = "name";
            playagain.SetScale(300);
            playagain.SetTexture("./App/Textures/playagain.png");
            AddHUDObject(playagain);

            botscorex = new HUDObjectText("Botscore:" + Stats.botscore);
            botscorex.SetPosition(Window.Width / 4, 100f);
            ...
            ballscorex.SetPosition(Window.Width / 4, 166f);
            ...
            clicks.SetPosition(Window.Width / 1.5f, 166f);
            clicks.Name = "clicks";
            clicks.SetScale(18);
            ...
            accuracy.SetPosition(Window.Width / 1.5f, 100f);
